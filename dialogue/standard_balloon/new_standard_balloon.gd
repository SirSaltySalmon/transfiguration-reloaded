...
func start(dialogue_resource: DialogueResource, title: String, extra_game_states: Array = [],
	...
	# Clicking on a character to start a dialogue will count as gui input and skip the first line
	#of text. This line solves this problem
	# Though currently doesnt need as start anim will do
